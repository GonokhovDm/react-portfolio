    ...
    <div className="app">
            ...
            <div className='col-lg-8 col-md-10 col-sm-12'>
              <div className="home__content">
                <div className="home__content-text">
                  ...
                  <p>Hi there! My name is Dmitry Gonokhov. I live and work in Novosibirsk, Russia. I'm just starting my journey into development, and I don't plan to stop.</p>
            ...
            <div className="col-lg-8">
              <div className="about__text">
                ...
                <div className="about__text-p">
                  <p>As a front-end developer, I have studied and practiced the following technologies: HTML, CSS, SCSS, JavaScript, React, React-Router, Bootstrap.</p>
                  <p>The technologies I have studied allow me to maintain and create responsive web-sites, user interfaces and components, the logic of their work and interaction from scratch.</p>
                  <p>Previously, I was fond of design, which allowed me to acquire confident knowledge in Photoshop, Corel Draw and Figma.</p>
                  <p>In addition to these professional skills, I am fond of sports, cars and travel.</p>
                </div>
              </div>
            </div>
      ...
      <section className="contacts">
        <div className="container">
          <div className="row">
            <div>
              <div className="col-12"><h2>Always ready for your suggestions!</h2></div>
